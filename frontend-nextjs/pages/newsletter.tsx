...
export default function NewsletterPage() {
  ...
  const content = {
    fr: {
      ...
      latestIssueDesc: 'Le meilleur de nos publications de recherche du trimestre, réuni dans un numéro unique : TITAN DC AI, marché de l\'infrastructure numérique, réglementation énergétique et financement brown-to-green.',
      latestIssueCta: 'Accéder à la note',
    ...
    en: {
      ...
      latestIssueDesc: 'The best of our quarterly research, gathered in a single issue: TITAN DC AI, digital infrastructure market, energy regulation and brown-to-green financing.',
      latestIssueCta: 'Access the note',
