...
export default function ArticleDatacentersModulairesPage() {
  ...
  const content = {
    ...
    en: {
      ...
      p7: "FINXIA Capital has integrated modularity into its TITAN DC AI strategy. The 47 brown assets identified in France, Spain and Italy are not sites for 100 MW datacenters. They are sites for 5 to 10 MW modules, rapidly deployable, progressively extensible, and certifiable ESG SFDR Art.9. The advantage: lower entry ticket, shorter payback period, and strategic flexibility.",
