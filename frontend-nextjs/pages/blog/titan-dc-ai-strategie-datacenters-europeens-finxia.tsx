...
export default function Article7Page() {
  ...
  return (
    <div data-testid="article-7-page" className="pt-20">
      <SEO title={t.title} description={t.description} canonical={language === 'fr' ? "https://finxiacapital.com/blog/titan-dc-ai-strategie-datacenters-europeens-finxia/" : "https://finxiacapital.com/en/blog/titan-dc-ai-european-datacenters-strategy-finxia/"} keywords={language === 'fr' ? "TITAN DC AI, transformation datacenter, brown-to-green, FINXIA Capital, PUE optimisation, datacenter Europe" : "TITAN DC AI, datacenter transformation, brown-to-green, FINXIA Capital, PUE optimization, European datacenter"} structuredData={articleSchema} breadcrumbSchema={breadcrumbSchema} language={language} ogLocale={language === 'fr' ? "fr_FR" : "en_US"} hreflangFr="https://finxiacapital.com/blog/titan-dc-ai-strategie-datacenters-europeens-finxia/" hreflangEn="https://finxiacapital.com/en/blog/titan-dc-ai-european-datacenters-strategy-finxia/" hreflangDefault="https://finxiacapital.com/blog/titan-dc-ai-strategie-datacenters-europeens-finxia/" />
        ...
        <div className="py-16 md:py-24">
          <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="prose prose-slate prose-lg max-w-none">
              ...
              <p>{language === 'fr' ? "FINXIA Capital est positionné à l'intersection de la finance alternative institutionnelle et de l'infrastructure technologique — combinant la rigueur d'une SCSp luxembourgeoise avec une architecture AI-native dédiée à l'optimisation opérationnelle des actifs datacenter." : "FINXIA Capital is positioned at the intersection of institutional alternative finance and technological infrastructure — combining the rigor of a Luxembourg SCSp with an AI-native architecture dedicated to datacenter asset operational optimization."}</p>
