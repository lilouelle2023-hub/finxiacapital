...
export default function Article7Page() {
  ...
  const articleSchema = {
    ...
    "datePublished": "2026-04-25T09:00:00+01:00",
    "dateModified": "2026-04-25T09:00:00+01:00",
    "author": {
      "@type": "Person",
      "name": "Lila Benhammou",
        ...
        <header className="py-16 md:py-24 bg-slate-50">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="flex items-center gap-4 mb-6 text-sm">
              ...
              <time className="text-slate-600 flex items-center gap-2" dateTime="2026-04-25"><Calendar className="w-4 h-4" />{t.date}</time>
              <span className="text-slate-400">•</span>
