...
export default function Article2Page() {
  ...
  const content = {
    fr: {
      title: 'Gérer un fonds alternatif avec des agents IA : ce que ça change vraiment',
      description: "La gestion d'actifs alternatifs a un problème de latence. L'architecture AI-native avec des agents IA opérant 24/7 transforme la gestion de portefeuille et l'exécution des stratégies d'investissement.",
      metaDescription: "La gestion d'actifs alternatifs a un problème de latence. L'architecture AI-native avec des agents IA opérant en continu change la donne pour les fonds d'investissement.",
      breadcrumbLabel: 'Gérer un fonds alternatif avec des agents IA',
      keywords: 'AI-native fund, agents IA investissement, gestion actifs alternatifs IA, Deal Intelligence Agent, Asset Monitor, architecture multi-agents, alternative asset management automatisé',
      ...
      h2_2: 'Ce que font nos agents en pratique',
      ...
      authorBioRest: 'est Co-Fondatrice et Directrice des Investissements (CIO) de FINXIA Capital SCSp. Architecte de l\'infrastructure IA du fonds (agents autonomes). Co-auteure du livre blanc "Optimisation Énergétique des Datacenters Européens" (SSRN, Abstract ID 6597918, 2026).',
      learnMore: 'En savoir plus',
      link1Title: 'Notre Approche AI-Native',
      link1Text: 'Découvrez comment nous déployons nos agents IA',
      link2Title: 'Gouvernance & Risques',
      link2Text: 'Framework de gestion des risques augmenté par IA',
    },
    en: {
      title: 'Running an Alternative Fund with AI Agents: What Actually Changes',
      description: 'Alternative asset management has a latency problem. AI-native architecture with AI agents operating 24/7 is transforming portfolio management and investment strategy execution.',
      metaDescription: 'Alternative asset management has a latency problem. AI-native architecture with AI agents operating continuously is changing the game for investment funds.',
      breadcrumbLabel: 'Running an Alternative Fund with AI Agents',
      keywords: 'AI-native fund, AI investment agents, AI alternative asset management, Deal Intelligence Agent, Asset Monitor, multi-agent architecture, automated alternative asset management',
      ...
      h2_2: 'What our agents actually do',
      ...
      p9: 'Other agents cover regulatory compliance, ESG reporting, portfolio risk management, banking relationships, and sector intelligence. Together, they form a processing layer that operates twenty-four hours a day, with no cognitive bias, no fatigue, no information loss in handoffs.',
      ...
      authorBioRest: 'is Co-Founder and Chief Investment Officer (CIO) of FINXIA Capital SCSp. Architect of the fund\'s AI infrastructure (autonomous agents). Co-author of the white paper "Energy Optimization of European Datacenters" (SSRN, Abstract ID 6597918, 2026).',
      learnMore: 'Learn more',
      link1Title: 'Our AI-Native Approach',
      link1Text: 'Discover how we deploy our AI agents',
