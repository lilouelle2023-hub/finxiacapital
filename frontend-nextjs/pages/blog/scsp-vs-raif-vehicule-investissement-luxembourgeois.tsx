...
export default function Article4Page() {
  ...
  const content = {
    fr: {
      ...
      p9: "La SCSp permet également à FINXIA Capital de maintenir une relation directe avec ses investisseurs institutionnels sans passer par un AIFM tiers — un avantage de contrôle et de qualité dans la communication financière et extrafinancière.",
      ...
      p11: "FINXIA Capital positionne sa stratégie TITAN DC AI sous le label SFDR Article 9 (produit financier durable). La SCSp est pleinement compatible avec les obligations de reporting SFDR : les indicateurs d'impact sont consolidés et reportés au niveau du véhicule.",
      h2_6: "Conclusion",
    ...
    en: {
      ...
      p9: "The SCSp also allows FINXIA Capital to maintain a direct relationship with its institutional investors without going through a third-party AIFM — a control and quality advantage in financial and extra-financial communication.",
      ...
      p11: "FINXIA Capital positions its TITAN DC AI strategy under the SFDR Article 9 label (sustainable financial product). The SCSp is fully compatible with SFDR reporting obligations: impact indicators are consolidated and reported at the vehicle level.",
      h2_6: "Conclusion",
