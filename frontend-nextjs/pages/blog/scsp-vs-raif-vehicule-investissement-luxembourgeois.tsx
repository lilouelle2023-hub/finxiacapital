...
export default function Article4Page() {
  ...
  const content = {
    fr: {
      ...
      h2_5: "5. Implications pour Nos Partenaires Financiers",
      p10: "Pour une contrepartie institutionnelle engagée sur le Green Bond ou les instruments de dette TITAN DC AI — banque, fonds de dette, investisseur obligataire — la structure SCSp de FINXIA Capital offre une lisibilité contractuelle directe : gouvernance resserrée, absence d'intermédiation AIFM, et transparence fiscale au niveau du véhicule.",
    ...
    en: {
      ...
      h2_5: "5. Implications for Our Financial Partners",
      p10: "For an institutional counterparty engaged on the TITAN DC AI Green Bond or debt instruments — bank, debt fund, bond investor — FINXIA Capital's SCSp structure offers direct contractual clarity: tight governance, no AIFM intermediation, and tax transparency at the vehicle level.",
