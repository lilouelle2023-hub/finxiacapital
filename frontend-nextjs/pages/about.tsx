...
export default function AboutPage() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      bio: language === 'fr'
        ? "Serial entrepreneur et investisseur avec 15+ ans de leadership cross-fonctionnel en asset management alternatif, private equity, infrastructure immobilière et transformation technologique. Lead des stratégies TITAN DC AI (datacenter + infrastructure télécom) et C.CAPITAL (investissements late-stage IA/tech) de FINXIA Capital. Executive MBA — Kellogg School of Management, Northwestern University (Chicago). Parcours opérationnel : Etrali (2005-2007, connectivity), Orange France & Orange Business Services (2007-2014, wireless product manager puis global account director — €25M/year, plus gros contrat outsourcing de l'histoire d'Orange €40M TCV), BT Global Services (2014-2016, managed services sales director — €4.8M EBITDA), Fruition Partners (2016-2026, South West Europe Lead — 6 pays, €11.5M turnover). Fondatrice de Humans4Help (H4H) en 2017, spécialiste IA et automation d'entreprise — €7.5M revenue, 85 employés, sortie réussie en 2023. Architecte de la stratégie TITAN DC AI et de son infrastructure opérationnelle. Expertise télécoms : fibre optique, raccordement HT, infrastructures réseau. 17 agents IA déployés pour optimisation du fonds. Lead author du livre blanc SSRN sur l'optimisation énergétique des datacenters européens (2026). Basée entre Paris, Genève et Amsterdam. L'ADN investissement et tech de FINXIA."
        : "Serial entrepreneur and investor with 15+ years of cross-functional leadership in alternative asset management, private equity, real estate infrastructure and technology-driven business transformation. Lead of FINXIA Capital's TITAN DC AI (datacenter + telecom infrastructure) and C.CAPITAL (late-stage AI/tech investments) strategies. Executive MBA — Kellogg School of Management, Northwestern University (Chicago). Operational track record: Etrali (2005-2007, connectivity), Orange France & Orange Business Services (2007-2014, wireless product manager then global account director — €25M/year, largest outsourcing contract in Orange history €40M TCV), BT Global Services (2014-2016, managed services sales director — €4.8M EBITDA), Fruition Partners (2016-2026, South West Europe Lead — 6 countries, €11.5M turnover). Founder of Humans4Help (H4H) in 2017, enterprise AI and automation specialist — €7.5M revenue, 85 employees, successful exit in 2023. Architect of the TITAN DC AI strategy and its operational infrastructure. Telecom expertise: fiber optics, HV connection, network infrastructure. 17 AI agents deployed for fund optimization. Lead author of the SSRN white paper on European datacenter energy optimization (2026). Based between Paris, Geneva and Amsterdam. The investment and tech DNA of FINXIA.",
      linkedin: 'https://linkedin.com/in/lilabenhammou',
      highlights: [
        { icon: Lightbulb, text: language === 'fr' ? 'Architecte TITAN DC AI — infrastructure datacenter + télécoms + 17 agents IA' : 'TITAN DC AI architect — datacenter + telecom + 17 AI agents' },
        { icon: BarChart3, text: language === 'fr' ? 'Orange, BT Global, Fruition Partners — 15+ ans track record opérationnel' : 'Orange, BT Global, Fruition Partners — 15+ years operational track record' },
        { icon: CheckCircle, text: language === 'fr' ? 'Sortie Humans4Help (2023) + Lead author SSRN 2026' : 'Humans4Help exit (2023) + SSRN lead author 2026' },
      ],
    },
  ];
