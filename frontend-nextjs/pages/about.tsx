...
export default function AboutPage() {
  ...
  const teamMembers = [
    ...
    },
    {
      ...
      bio: language === 'fr'
        ? "Serial entrepreneur et investisseur avec 15+ ans de leadership cross-fonctionnel en asset management alternatif, private equity, infrastructure immobilière et transformation technologique. Lead des stratégies TITAN DC AI et C.CAPITAL de FINXIA Capital. Executive MBA — Kellogg School of Management, Northwestern University (Chicago). Carrière télécoms et IT chez Etrali, Orange et BT Global Services : négociation institutionnelle, gestion de comptes globaux, P&L, contrats outsourcing, transformation digitale et services cloud. Fondatrice de Humans4Help (H4H), spécialiste IA et automation d'entreprise — sortie réussie en 2023. Architecte de la stratégie TITAN DC AI et de son infrastructure opérationnelle. Expertise télécoms : fibre optique, raccordement HT, infrastructures réseau. Autrice de deux ouvrages (2020, 2026) ; lead author du livre blanc sur l'optimisation énergétique des datacenters européens (2026). Basée entre Paris et Genève. L'ADN investissement et tech de FINXIA."
        : "Serial entrepreneur and investor with 15+ years of cross-functional leadership in alternative asset management, private equity, real estate infrastructure and technology-driven business transformation. Lead of FINXIA Capital's TITAN DC AI and C.CAPITAL strategies. Executive MBA — Kellogg School of Management, Northwestern University (Chicago). Telecom and IT career at Etrali, Orange and BT Global Services: institutional negotiation, global account management, P&L, outsourcing contracts, digital transformation and cloud services. Founder of Humans4Help (H4H), enterprise AI and automation specialist — successful exit in 2023. Architect of the TITAN DC AI strategy and its operational infrastructure. Telecom expertise: fiber optics, HV connection, network infrastructure. Author of two books (2020, 2026); lead author of the white paper on European datacenter energy optimization (2026). Based between Paris and Geneva. The investment and tech DNA of FINXIA.",
